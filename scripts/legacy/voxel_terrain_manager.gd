...
func _build_biome_materials() -> void:
	...
	var gt: Texture2D = plains_albedo if plains_albedo != null else _load_tex("res://assets/textures/Poliigon_GrassPatchyGround_4585/2K/Poliigon_GrassPatchyGround_4585_BaseColor.jpg")
	var gn: Texture2D = plains_normal if plains_normal != null else _load_tex("res://assets/textures/Poliigon_GrassPatchyGround_4585/2K/Poliigon_GrassPatchyGround_4585_Normal.png")
	var gr: Texture2D = plains_roughness if plains_roughness != null else _load_tex("res://assets/textures/Poliigon_GrassPatchyGround_4585/2K/Poliigon_GrassPatchyGround_4585_Roughness.jpg")
	if gt != null:
	...
	var st: Texture2D = desert_albedo if desert_albedo != null else _load_tex("res://assets/textures/GroundSand005/GroundSand005_COL_2K.jpg")
	var sn: Texture2D = desert_normal if desert_normal != null else _load_tex("res://assets/textures/GroundSand005/GroundSand005_NRM_2K.jpg")
	var sr: Texture2D = desert_roughness if desert_roughness != null else _load_tex("res://assets/textures/GroundSand005/GroundSand005_GLOSS_2K.jpg")
	if st != null:
	...
	var snt: Texture2D = peaks_albedo if peaks_albedo != null else _load_tex("res://assets/textures/Snow004_2K-JPG/Snow004_2K-JPG_Color.jpg")
	var snn: Texture2D = peaks_normal if peaks_normal != null else _load_tex("res://assets/textures/Snow004_2K-JPG/Snow004_2K-JPG_NormalDX.jpg")
	if snt != null:
	...
	var rt: Texture2D = cave_albedo if cave_albedo != null else _load_tex("res://assets/textures/rocks_ground_04_2k.blend/textures/rocks_ground_04_diff_2k.jpg")
	var rn: Texture2D = cave_normal if cave_normal != null else _load_tex("res://assets/textures/rocks_ground_04_2k.blend/textures/rocks_ground_04_nor_2k.jpg")
	var rr: Texture2D = cave_roughness if cave_roughness != null else _load_tex("res://assets/textures/rocks_ground_04_2k.blend/textures/rocks_ground_04_rough_2k.jpg")
	if rt != null:
