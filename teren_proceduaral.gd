...
func _init_materials() -> void:
	...
	_apply_pbr_texture(material_stone,
		...
		"res://rocks_ground_04_2k.blend/textures/rocks_ground_04_nor_gl_2k.png",
	...
	if ResourceLoader.exists("res://water.tres"):
		material_water = load("res://water.tres")
...
func _build_chunk_shader_material() -> ShaderMaterial:
	...
	# 0: Grass
	albedo_images.append(_load_img_resized("res://Poliigon_GrassPatchyGround_4585/2K/Poliigon_GrassPatchyGround_4585_BaseColor.jpg", TEX_SIZE))
	normal_images.append(_load_img_resized("res://Poliigon_GrassPatchyGround_4585/2K/Poliigon_GrassPatchyGround_4585_Normal.png", TEX_SIZE))
	height_images.append(_load_img_resized("res://Poliigon_GrassPatchyGround_4585/2K/Poliigon_GrassPatchyGround_4585_Displacement.png", TEX_SIZE))
	# 1: Dirt
	albedo_images.append(_load_img_resized("res://GroundSand005/GroundSand005_COL_2K.jpg", TEX_SIZE))
	normal_images.append(_load_img_resized("res://GroundSand005/GroundSand005_NRM_2K.jpg", TEX_SIZE))
	height_images.append(_load_img_resized("res://GroundSand005/GroundSand005_DISP_2K.jpg", TEX_SIZE))
	# 2: Stone
	albedo_images.append(_load_img_resized("res://rocks_ground_04_2k.blend/textures/rocks_ground_04_diff_2k.jpg", TEX_SIZE))
	normal_images.append(_load_img_resized("res://rocks_ground_04_2k.blend/textures/rocks_ground_04_nor_gl_2k.png", TEX_SIZE))
	height_images.append(_load_img_resized("res://rocks_ground_04_2k.blend/textures/rocks_ground_04_disp_2k.png", TEX_SIZE))
	...
	mat.shader = preload("res://terrain_shader.gdshader")
